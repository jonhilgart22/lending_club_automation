...
def split_scale_data(input_df):
    ...
    x_cols = lending_club_df_training.iloc[:,input_df.columns!='repaid'] 
...
if __name__ == "__main__":
    ...
    if len(sys.argv)!=3:
        sys.stderr.write("You need to pass in two additional arguments. 1: The number of epochs, 2: The batch size\n")
    ...
    'repaid','delinq_2yrs','inq_last_6mths','mths_since_last_delinq','mths_since_last_record','open_acc','pub_rec','revol_bal','revol_util','total_acc','collections_12_mths_ex_med','mths_since_last_major_derog','acc_now_delinq',
    'tot_coll_amt',
    ...
    'month',
    'term_ 36 months',
    'term_ 60 months','grade_A','grade_B','grade_C','grade_D','grade_E','grade_F','grade_G','home_ownership_ANY','home_ownership_MORTGAGE',
    ...
    'purpose_vacation','purpose_wedding','addr_state_AK','addr_state_AL','addr_state_AR','addr_state_AZ','addr_state_CA',
    'addr_state_CO',
    'addr_state_CT',
    'addr_state_DC',
    'addr_state_DE','addr_state_FL','addr_state_GA','addr_state_HI','addr_state_IA','addr_state_ID','addr_state_IL',
    'addr_state_IN','addr_state_KS','addr_state_KY','addr_state_LA','addr_state_MA','addr_state_MD','addr_state_ME',
    'addr_state_MI','addr_state_MN',
    'addr_state_MO','addr_state_MS','addr_state_MT','addr_state_NC','addr_state_ND','addr_state_NE','addr_state_NH','addr_state_NJ','addr_state_NM',
    'addr_state_NV',
    'addr_state_NY',
    'addr_state_OH',
    'addr_state_OK',
    ...
    # Fit the model 
    history = m.fit( X_train,y_train , epochs = epo,batch_size=batch_size_in, validation_split=.05, verbose=1)
    ...
    with open('models/mlp_model_{}-epochs_{}-batchsize_{}-train_accuracy{}-val_acc.h5'.format(epo,batch_size_in,train_acc,val_acc), "w") as json_file:
